 ...
 * @Date:   2018-02-25T19:07:57-05:00
 * @Email:  zzeng@terpmail.umd.edu
 * @Last modified by:   yzy
 * @Last modified time: 2018-02-25T19:46:39-05:00
 * @License: BSD
 */
        ...
        if (!has_been_zeroed_) {
                ...
                if(num_tools_in_tray_ == 0 && order_0_ == false) {
                        ...
                        if(gripper_state_attatch_ == false) {
                                ...
                                move_to(middle_p,goal,traj,joint_state_msg,pass_order0[1]);
                        }
...
void send_arm_to_zero_state() {
        ...
        msg.points[0].positions = {1.96, 0.0, -1.0, 3.14,3.58,-1.51,0.0};
